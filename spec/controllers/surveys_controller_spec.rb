  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved survey as @survey" do
        ...
        post :create, {:survey => { "description" => "invalid value" }}, valid_session
        assigns(:survey).should be_a_new(Survey)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested survey" do
        ...
        Survey.any_instance.should_receive(:update_attributes).with({ "description" => "MyText" })
        put :update, {:id => survey.to_param, :survey => { "description" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the survey as @survey" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Survey.any_instance.stub(:save).and_return(false)
        put :update, {:id => survey.to_param, :survey => { "description" => "invalid value" }}, valid_session
        assigns(:survey).should eq(survey)
      end
